...
declare namespace ECharts {
    ...
    namespace graphic {
        class LinearGradient {
            constructor(x:number, y:number, x2:number, y2:number, colorStops:Array<Object>, globalCoord:boolean);
        }
        class RadialGradient {
            constructor(x:number, y:number, r:number, colorStops:Array<Object>, globalCoord:boolean);
        }
    }
